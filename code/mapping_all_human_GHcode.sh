...
obj <- c(NA18856, NA18855, NA19160, H1, H2, H3, H5)
...
save(integrate, file = "/project/gilad/emaan/time_project/data/integrating_EM_GH/integrate_all_human_var_pca_nonreg.RData")
