...
obj <- c(NA18856, NA18855, NA19160, H1, H2, H3, H5, wu_combined_rev)
...
save(integrate, file = "/project/gilad/emaan/time_project/data/Wu_reference_mapping/integrate_Wu_var_cca_reg.RData")
