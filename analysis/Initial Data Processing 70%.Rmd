...
Data being pulled is from the /project/gilad/emaan/chondro_rev folder. There is another folder named /project/gilad/emaan/chondro but data from that folder is not being used (since there was an issue with the bam files not merging/taking to long). Vireo was also only run on the chondro_rev folder. 
