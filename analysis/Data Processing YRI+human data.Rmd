...
Integrating EM+GH data using GH code. The code used is in /project/gilad/emaan/time_project/code. The output files are saved in /project/gilad/emaan/time_project/data/integrating_EM_GH. 
```{r}
